...
const ModalTransport: React.FC<ModalTransportProps> = ({
    isOpen,
    onClose,
    onNavigate,
    transportData,
}) => {
    if (!isOpen || !transportData) return null;
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center">
                        <h3 className="text-3xl font-medium text-[#0F2976] mt-3">
                            Tipo de Transporte: <span className="font-bold text-black">{transportData.tipoTransporte}</span>
                        </h3>
                        {/* ...ícone dinâmico se quiser... */}
                    </div>
                    <p className="text-lg text-[#3B4449] mt-4">
                        {transportData.descricao}
                    </p>
                </div>
                        ...
                        <div className="bg-[rgba(65,130,249,0.24)] rounded-lg p-4 shadow-md w-full">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#3B4449]">
                                        <span className="font-bold">Data de Saída:</span> {transportData.ida.dataSaida}<br />
                                        <span className="font-bold">Local:</span> {transportData.ida.localSaida}
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#3B4449]">
                                        <span className="font-bold">Data de Chegada:</span> {transportData.ida.dataChegada}<br />
                                        <span className="font-bold">Local:</span> {transportData.ida.localChegada}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[rgba(0,255,77,0.11)] rounded-lg p-4 shadow-md w-full">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#3B4449]">
                                        <span className="font-bold">Data de Retorno:</span> {transportData.volta.dataSaida}<br />
                                        <span className="font-bold">Local:</span> {transportData.volta.localSaida}
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 mt-4">
                                <img src="/images-modals/Icons/MapIcon.png" alt="Ícone de localização" className="w-12 h-12" />
                                <div>
                                    <p className="text-xl text-[#0B772B] font-bold">Chegada na Cidade Origem</p>
                                    <p className="text-sm text-[#3B4449]">
                                        <span className="font-bold">Data de Chegada:</span> {transportData.volta.dataChegada}<br />
                                        <span className="font-bold">Local:</span> {transportData.volta.localChegada}
                                    </p>
                                </div>
                            </div>
                        </div>
