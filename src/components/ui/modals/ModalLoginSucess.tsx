    ...
    const modalContent = (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <div className="p-6 rounded bg-white text-center shadow-lg border-green-500 border min-w-[300px]">
                ...
                <button
                    className="bg-green-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-green-700 transition cursor-pointer hover:transform hover:scale-105 transition duration-200"
                    onClick={onClose}
                >
                    Fechar
                </button>
