...
export default function HomePage() {
  ...
  const handleJoinTrip = async () => {
    ...
    try {
      ...
      // Exibe o modal de sucesso sobre a tela principal
      setTimeout(() => {
  ...
  return (
    <>
      {showSuccess && (
        <div className="fixed top-10 left-1/2 transform -translate-x-1/2 z-50 px-8 py-4 rounded-lg text-white text-2xl font-bold bg-green-600 shadow-lg">
