...
export default function TripBudget() {
  ...
  const viagemStr =
    typeof window !== "undefined"
      ? localStorage.getItem("viagemEmCriacao")
      : null;
  let tripData = {
    name: "",
    startDate: "",
          ...
          <WhiteBackground titulo="Criar Orçamento">
            <div className="mb-6 ml-20">
              ...
              <div className="flex items-center gap-4 mb-1 text-[1.3rem]">
                <CalendarDays className="text-[#0F2976]" />
                <span>
                  Data: <b className="text-[#0F2976]">{tripData.startDate}</b>{" "}
                  até <b className="text-[#0F2976]">{tripData.endDate}</b>
                </span>
              </div>
              <div className="flex items-center gap-4 mb-1 text-[1.3rem]">
                <Earth className="text-[#0F2976]" />
                <span>
                  Local: <b className="text-[#0F2976]">{tripData.location}</b>
                </span>
              </div>
              <div className="flex items-center gap-4 text-[1.3rem]">
                <Users className="text-[#0F2976]" />
                <span>
                  Participantes:{" "}
