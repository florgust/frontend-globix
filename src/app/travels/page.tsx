    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-b from-[#1C4CDC] to-[#0F2976] ">
            ...
            <div className="flex flex-col items-center w-full bg-[#0F2976]">
                <div className="absolute top-12 ml-5 items-center justify-center w-1/5 h-18 p-4 bg-[#1C4CDC]" />

                <div className="absolute top-10 items-center justify-center w-1/5 h-18 p-4 bg-white">
                    <h1 className="text-2xl font-bold text-center text-[#0F2976]">{detalhesViagem.viagem.nome}</h1>
                </div>

                {/* div branca */}
                <div className="flex flex-col bg-white rounded-lg shadow-lg mt-30 w-4/5 h-150 mb-50">
                    ...
                    <div className='p-4 w-full h-full'>
                        <div className="flex flex-row w-full h-full justify-between items-center">
                            ...
                            <div className="grid grid-cols-2 gap-4 overflow-x-auto">
                                ...
                                {isModalOpen && (
                                    <Modal isOpen={isModalOpen}>
                                        <div className='relative w-full h-20 items-centescmd'>
                                            {/* Primeira div */}
                            ...
                            {/* Div com o gradiente */}
                            <div className="flex items-center justify-center w-full h-100 sm:w-2/3 sm:h-2/3 lg:w-1/2 lg:h-1/2">
                                <div
                                    style={{
                                        scrollbarWidth: "thin", // Para navegadores compatíveis
                                        scrollbarColor: "#fffff #0F2976", // Cor do polegar e do fundo
                                    }}
                                    className="w-3/4 h-48 bg-gradient-to-b from-[#1C4CDC] to-[#0F2976] rounded-2xl overflow-y-auto"
                                >
                                    <UserList usuarios={detalhesViagem.usuario} />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col h-full justify-center ">
                                <div className="flex gap-4">
                                    <div className="flex flex-col items-center">
                                        ...
                                        />
                                        <p className="text-sm text-gray-500 mt-2">Detalhes</p>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center">
                                        <IconButton
                                            ...
                                            onClick={() => alert("Botão clicado!")}
                                        />
                                        <p className="text-sm text-gray-500 mt-2">Transporte</p>
                                    ...
                                    <div className="flex flex-col items-center">
                                        <IconButton
                                            ...
                                            onClick={() => alert("Botão clicado!")}
                                        />
                                        <p className="text-sm text-gray-500 mt-2">Itinerário</p>
                                    </div>
                                </div>
