            ...
            <div className="flex flex-col items-center w-full bg-gradient-to-b from-[#1C4CDC] to-[#0F2976]">
                ...
                <div className="flex flex-col items-center w-3/4 h-230 mt-8 p-4 border border-[#00FF4D] rounded-4xl shadow-lg">
                    ...
                    <div className="relative w-[98%]">
                        ...
                        <div className="flex mt-10 h-15 justify-beetween">
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        <CalendarIcon className="mr-2 h-16 w-16 text-[#0F2976]" />
                            ...
                            <p className='flex items-center justify-center bg-white w-30 rounded-tl-2xl ml-100 rounded-bl-2xl font-bold text-[#3B4449]'>Data Final</p>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        <CalendarIcon className="text-[#0F2976] mr-2 h-16 w-16" />
