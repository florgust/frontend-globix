...
export default function TravelTransport() {
  ...
  useEffect(() => {
    const fetchTransporte = async () => {
      try {
        ...
        setAlertMessage("Erro ao carregar dados do transporte.");
      }
    };
    fetchTransporte();
  }, []);
  ...
  const handleSave = async () => {
    ...
    if (!transporteId) {
      setAlertMessage("Transporte não encontrado para atualizar.");
      return;
    }
    ...
    try {
      ...
      setAlertMessage("Ocorreu um erro ao atualizar o transporte. Tente novamente.");
    }
  };
