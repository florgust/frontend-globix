                        ...
                        <div className="flex flex-row w-full h-full justify-between">
                            ...
                            <div className="flex flex-col relative items-center justify-center w-full h-100 sm:w-2/3 sm:h-3/3">
                                <div className="absolute top-0 w-3/5 flex items-center justify-center bg-[#D9D9D9] rounded-full h-12 mb-4">
                                    {/* Fundo animado */}
                                    <div
                                        className={`absolute top-0 h-full w-full bg-[#1C4CDC] rounded-full "
                                            }`}
                                    ></div>
                                    ...
                                    <div className="relative flex w-full">
                                        <button
                                            className={`z-10 flex items-center justify-center w-full py-2 text-2xl font-bold transition-all duration-300 ${
                                                activeButton === "convidados" ? "text-white" : "text-[#0F2976]"
                                            }`}
